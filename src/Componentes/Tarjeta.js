...
import rayomc from '../Imagenes/rayomc.png'
...
class Tarjeta extends React.Component{
    ...
    render(){
        ...
        return (
            <div className="card mx-auto Fitness-Card"
            style={{
                backgroundImage: `url(${circlesImg}), linear-gradient(to right, ${leftColor || '#F80000 '}, ${rightColor || '#2F80ED'})`
            }}
            >
                <div className="card-body">
                    <div className="row center">
                        <div className="col-6">
                            <img src={img || rayomc} alt="" className="float-right ti"/>
                        </div> 
                        <div className="col-6 Fitness-Card-Info">
                            <h1>{title}</h1>
                            <p>{description}</p>
